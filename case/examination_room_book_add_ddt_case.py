...
if __name__ == "__main__":
    ...
    # 添加测试用例
    suite = unittest.TestLoader().loadTestsFromTestCase(ExaminationRoomBookAddDdtCase)
    ...
    runner = HTMLTestRunner(stream=f, title='考场管理测试报告', description='考点基本信息通讯录添加测试用例执行结果如下： ')
    runner.run(suite)

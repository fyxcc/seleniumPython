...
class ExaminationEnvirBusiness(object):
    ...
    def envir_success_edit(self,  envir_edit_place_area, envir_edit_place_spread, envir_edit_toilet_condition, envir_edit_cars_num):
    ...
    def envir_edit_function(self,  envir_edit_place_area, envir_edit_place_spread, envir_edit_toilet_condition, envir_edit_cars_num,
        ...
        self.envir_success_edit( envir_edit_place_area, envir_edit_place_spread, envir_edit_toilet_condition, envir_edit_cars_num)
    ...
    def clear_all_machine(self):
        ...
        #self.Eeh.clear_machine_edit_center_switch_board()
        #self.Eeh.clear_machine_edit_insert_switch_board()
        #self.Eeh.clear_machine_edit_framework()

    # 机器设备成功编辑

    def machine_success_edit(self, machine_edit_available_examination, machine_edit_processor, machine_edit_storage,machine_edit_caliche,machine_edit_ups_model,machine_edit_ups_time):

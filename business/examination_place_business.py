...
class ExaminationPlaceBusiness(object):
    ...
    # 数据驱动整合代码
    def login_function(self, place_code, place_name, place_address, place_person, place_person_tel, assertCode,
                       assertText):
        self.common_login(place_code, place_name, place_address, place_person, place_person_tel)
        if len(assertCode) != 0:
